...
public partial class Perfil : System.Web.UI.Page
{
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplPerfiles.html");
            ...
            Pagina = Pagina.Replace("[Title]", "Perfiles");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Catalogo.Perfil.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
