...
public partial class Tarifa : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!permiso.tienePermiso("accesoTarifa"))
        {
    ...
    public void MostrarContenido() {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplTarifas.html");
            ...
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Catalogo.Tarifa.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
