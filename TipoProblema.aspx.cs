...
public partial class TipoProblema : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
        CSecurity permiso = new CSecurity();
        if (!permiso.tienePermiso("accesoTipoProblema"))
        {
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplTipoProblemas.html");
            ...
            Pagina = Pagina.Replace("[Title]", "TipoProblemas");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Control.TipoProblema.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
