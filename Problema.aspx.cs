...
public partial class Problema : System.Web.UI.Page
{
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplProblemas.html");            
            ...
            Pagina = Pagina.Replace("[Title]", "Problemas");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Control.Problema.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
