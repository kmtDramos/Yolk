...
public partial class Menu : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!permiso.tienePermiso("accesoMenu"))
        {
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplMenus.html");
            ...
            Pagina = Pagina.Replace("[Title]", "Menú");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Seguridad.Menu.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
