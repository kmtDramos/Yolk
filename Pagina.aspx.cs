...
public partial class Pagina : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!permiso.tienePermiso("accesoPagina"))
        {
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplPaginas.html");
            ...
            Pagina = Pagina.Replace("[Title]", "Paginas");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Catalogo.Pagina.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
