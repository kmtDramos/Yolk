...
public partial class Proveedor : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!permiso.tienePermiso("accesoPerfil"))
        {
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate (CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplProveedor.html");
            ...
            Pagina = Pagina.Replace("[Title]", "Proveedor");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Catalogo.Proveedor.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
