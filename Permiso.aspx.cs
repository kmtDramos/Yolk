...
public partial class Permiso : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
        ...
        if (!permiso.tienePermiso("accesoPermiso"))
        {
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplPermisos.html");            
            ...
            Pagina = Pagina.Replace("[Title]", "Permisos");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Control.Permiso.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
