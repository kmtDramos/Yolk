...
public partial class Medicion : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
        ...
        if (!permiso.tienePermiso("accesoReporteMetaVsReal"))
        {
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplMedicion.html");
            ...
            Pagina = Pagina.Replace("[Title]", "Medición");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Control.Medicion.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
