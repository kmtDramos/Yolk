...
public partial class Cliente : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!permiso.tienePermiso("accesoCliente"))
        {
    ...
    public void MostrarContenido() {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplClientes.html");
            ...
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Catalogo.Cliente.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
