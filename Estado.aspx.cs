...
public partial class Estado : System.Web.UI.Page
{
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplEstado.html");            
            ...
            Pagina = Pagina.Replace("[Title]", "Estado");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Control.Estado.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
