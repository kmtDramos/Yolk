...
public partial class Municipio : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
        ...
        if (!permiso.tienePermiso("accesoMunicipio"))
        {
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplMunicipio.html");
            ...
            Pagina = Pagina.Replace("[Title]", "Municipio");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Control.Municipio.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
