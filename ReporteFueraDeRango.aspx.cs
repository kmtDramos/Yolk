...
public partial class ReporteFueraDeRango : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        CSecurity permiso = new CSecurity();
        if (!permiso.tienePermiso("accesoReporteEstatusPorCircuito"))
        {
    ...
    public void MostrarContenido() {
        ...
        CUnit.Firmado(delegate(CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplReporteFueraDeRango.html");
            ...
            Pagina = Pagina.Replace("[Title]", "Reporte Fuera de Rango");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Control.ReporteFueraDeRango.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
