...
(function() {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function() {
        ...
        return h(d, c), d.prototype.gridDefaults = {
            ...
            gridStrokeWidth: .5,
            gridTextColor: "#888",
			gridUnderlineColor: "#888",
			gridUnderlineDecoration: "underline",
            gridTextSize: 12,
            ...
            return this.raphael.text(a, b, c).attr("font-size", this.options.gridTextSize).attr("font-family", this.options.gridTextFamily).attr("font-weight", this.options.gridTextWeight).attr("text-decoration", this.options.gridUnderlineDecoration).attr("text-decoration-color", this.options.gridUnderlineColor).attr("text-decoration-color", this.options.gridTextColor).attr("text-anchor", "end")
        ...
        return h(c, a), c.prototype.init = function() {
            ...
            return this.raphael.text(a, b, c).attr("font-size", this.options.gridTextSize).attr("font-family", this.options.gridTextFamily).attr("font-weight", this.options.gridTextWeight).attr("text-decoration-color", this.options.gridUnderlineColor).attr("text-decoration", this.options.gridUnderlineDecoration).attr("fill", this.options.gridTextColor)
