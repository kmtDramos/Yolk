...
public partial class Pais : System.Web.UI.Page
{
    ...
    public void MostrarContenido()
    {
        ...
        CUnit.Firmado(delegate (CDB Conn)
        {
            ...
            string Pantalla = CViews.CargarView("tmplPais.html");
            ...
            Pagina = Pagina.Replace("[Title]", "Paises");
            Pagina = Pagina.Replace("[Contenido]", Contenido);
            Pagina = Pagina.Replace("[JS]", "<script src=\"js/Catalogo.Pais.js?_=" + DateTime.Now.Ticks + "\"></script>");
        });
